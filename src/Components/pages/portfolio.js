...
return (
  ...
  {/*Project 2 */}
   <Card shadow={5} style ={{minWidth: '450'}}>
   <CardTitle style={{color: '#fff',height:'176px',background:'url(https://i.ytimg.com/vi/UEj1FdNq0V4/maxresdefault.jpg) center / cover'}}></CardTitle>
   <CardText>
 ...
 <br />
  <Card shadow={5} style ={{minWidth: '450'}}>
  <CardTitle style={{color: '#fff',height:'176px',background:'url(https://javascriptif4.files.wordpress.com/2018/10/weatherapp.jpg?w=1100) center / cover'}}></CardTitle>
  <CardText>
  <h5>React Weather</h5>
...
<br />
 ...
 <Card shadow={5} style ={{minWidth: '450'}}>
    ...
    <CardActions border>
      ...
      <Button href="https://github.com/alexjivov/React-Chat-App" colored>Live Demo</Button>
    </CardActions>
    <CardMenu style={{color: '#fff'}}>
      <IconButton name="share" />
    </CardMenu>
...
This is a guessing game using numbers where the player will guess with numbered crystals.The player wins the game if their total score matches the random number and the player loses the game if their total score goes above the random number.
</CardText>
<CardActions border>
...
Built 30 vanilla JavaScript projects in 30 days using tutorials. No compilers, libraries, or frameworks were utizilied whatsoever. Example projects include a native voice synthesizer, custom HTML5 Video Player, and CSS + JS Clock.
</CardText>
<CardActions border>
...
<CardActions border>
  <Button href="https://github.com/alexjivov/burger-handlebars-app" colored>Github</Button>
